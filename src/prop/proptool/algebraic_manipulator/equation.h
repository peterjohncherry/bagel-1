...
class Equation_Base {
   ...
   public :
     ...
     Equation_Base( std::string name, std::string type, 
                    std::shared_ptr<std::map<std::string, std::shared_ptr<std::vector<BraKet<DataType>>>>>  term_map,
                    std::shared_ptr<std::map<std::string, std::shared_ptr<std::vector<std::pair<DataType,std::string>>>>> expression_term_map )
                    : name_(name), type_(type), term_map_(term_map), expression_term_map_(expression_term_map){} 
...
class Equation_Value : public Equation_Base<DataType> {
   ...
   public :
     ...
     Equation_Value( std::string name, std::string type, 
                    std::shared_ptr<std::map<std::string, std::shared_ptr<std::vector<BraKet<DataType>>>>>  term_map,
                    std::shared_ptr<std::map<std::string, std::shared_ptr<std::vector<std::pair<DataType,std::string>>>>> expression_term_map )
                    : Equation_Base<DataType>( name, type, term_map, expression_term_map  ) {}  
