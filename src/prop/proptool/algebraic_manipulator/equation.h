...
class Equation_Base {
   ...
   protected :
     ...
     std::shared_ptr< std::map <std::string, std::shared_ptr< BraKet_Base>>> braket_map_;
...
//     std::shared_ptr<std::vector<std::<std::tuple<std::pair<std::string,int>>>>> term_val_list_;
   ...
   public :
    ...
    ~Equation_Base(){};
     ...
     std::string add_expression_info( std::shared_ptr<std::vector<std::shared_ptr<BraKet_Base>>> expr_bk_list );
