...
class Gamma_Computer { 
    ...
    public: 
      Gamma_Computer( std::shared_ptr< std::map< std::string, std::shared_ptr<GammaInfo_Base>>>          Gamma_info_map,
      ...
      void build_gamma2_tensor(std::shared_ptr<GammaInfo_Base> gamma2_info );

      void build_sigma2_tensor(std::shared_ptr<GammaInfo_Base> gamma2_info );

      void build_sigmaN_tensor(std::shared_ptr<GammaInfo_Base> gamma_info );

      void build_gammaN_tensor(std::shared_ptr<GammaInfo_Base> gamma_info );
      ...
      void build_detspace(std::shared_ptr<CIVecInfo_Base>  ci_info );
      ...
      bool build_sigma_4idx_tensor_tests(std::shared_ptr<GammaInfo_Base> gamma_4idx_info ) ;
