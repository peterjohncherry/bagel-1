...
namespace Tensor_Arithmetic_P { 

template<class DataType>
class Tensor_Arithmetic_P { 
...
template<> void Tensor_Arithmetic_P<double>::gemm ( char op1, char op2, int size_i, int size_l, int size_j, 
                                                  double* A_data, double* B_data, double* C_data, double alpha, double beta );

template<> void Tensor_Arithmetic_P<std::complex<double>>::gemm( char op1, char op2, int size_i, int size_l, int size_j, 
                                                          std::complex<double>* A_data, std::complex<double>* B_data, std::complex<double>* C_data,
                                                          std::complex<double> alpha, std::complex<double> beta );

template<> void Tensor_Arithmetic_P<double>::gemv( char op1, int size_i, int size_j, double* A_data, double* B_data, double* C_data, double alpha, double beta ); 

template<> void Tensor_Arithmetic_P<std::complex<double>>::gemv( char op1, int size_i, int size_j,
                                                               std::complex<double>* A_data, std::complex<double>* B_data, std::complex<double>* C_data, 
                                                               std::complex<double> alpha, std::complex<double> beta );

template<> void Tensor_Arithmetic_P<double>::scaler( int T1_block_size, double T2_data_ptr, double* Tout_data_ptr);  

template<> void Tensor_Arithmetic_P<std::complex<double>>::scaler( int T1_block_size, std::complex<double> T2_data_ptr, std::complex<double>* Tout_data_ptr);  

template<> double Tensor_Arithmetic_P<double>::dot_product( size_t vec_size, double* v1, double* v2);

template<> std::complex<double> Tensor_Arithmetic_P<std::complex<double>>::dot_product( size_t vec_size, std::complex<double>* v1, std::complex<double>* v2); 

template<> void Tensor_Arithmetic_P<std::complex<double>>::ax_plus_y( int array_length, std::complex<double> factor, std::complex<double>* target_ptr, std::complex<double>* summand_ptr );

template<> void Tensor_Arithmetic_P<double>::ax_plus_y( int array_length, double factor, double* target_ptr, double* summand_ptr );

template<> void Tensor_Arithmetic_P<double>::diagonalize_matrix_hermitian( int nrows, double* orig_data_ptr, double* eigenvalues_ptr ); 

template<> void Tensor_Arithmetic_P<std::complex<double>>::diagonalize_matrix_hermitian( int nrows, std::complex<double>* orig_data_ptr, double* eigenvalues_ptr ); 

template<> void Tensor_Arithmetic_P<double>::invert_matrix_general( int nrows, int ncols, double* data_ptr );

template<> void Tensor_Arithmetic_P<double>::half_inverse_matrix_hermitian( int nrows, std::unique_ptr<double[]>& orig_data_ptr ); 

//template<> void Tensor_Arithmetic_P<double>::put_sub_tensor( std::shared_ptr<SMITH::Tensor_<double>> Tens1, std::shared_ptr<SMITH::Tensor_<double>> Tens2 );

//template<> void Tensor_Arithmetic_P<std::complex<double>>::put_sub_tensor( std::shared_ptr<SMITH::Tensor_<std::complex<double>>> Tens1, std::shared_ptr<SMITH::Tensor_<std::complex<double>>> Tens2 );
}
}
#endif
