...
class Expression_Computer {
  ...
  public:
    ...
    Expression_Computer() { throw std::logic_error(" Should never use default Expression_Computer contructor! Aborting!"); }

    Expression_Computer( std::shared_ptr<Gamma_Computer::Gamma_Computer<DataType>> gamma_computer,
