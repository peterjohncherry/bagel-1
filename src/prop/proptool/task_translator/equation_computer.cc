...
cout << " tensop_name  = "<< tensop_name << endl; 
#endif ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifdef __DEBUG_PROPTOOL_EQUATION_COMPUTER_BASE 
cout << "Equation_Computer_Base<DataType>::get_tensop_vector (name, fixed) : tensop_name = "; cout.flush(); cout  << tensop_name << endl;  
#endif ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

  throw logic_error( " THIS IS IMPLEMENTED WITH A HACK FOR THE RANGE; JUST SETS INDEXES AS 1-5 ! COMMENT THIS OUT IF YOU WANT TO RUN IT, BUT MUST BE FIXED ");
...
for ( auto& xx : fixed_idxs ) {   cout << "(" << xx.first << ","<< xx.second << ") "; cout.flush(); } cout << "]" << endl;
#endif ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
